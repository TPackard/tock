...
register_structs! {
    ClockRegisters {
        ...
        (0x028 => _reserved2),
        (0x080 => subscribe_hfclkstart: ReadWrite<u32, Configuration::Register>),
        (0x084 => subscribe_hfclkstop: ReadWrite<u32, Configuration::Register>),
        (0x088 => subscribe_lfclkstart: ReadWrite<u32, Configuration::Register>),
        (0x08C => subscribe_lfclkstop: ReadWrite<u32, Configuration::Register>),
        (0x090 => subscribe_cal: ReadWrite<u32, Configuration::Register>),
        (0x094 => _reserved3),
        (0x098 => subscribe_hfclkaudiostart: ReadWrite<u32, Configuration::Register>),
        (0x09C => subscribe_hfclkaudiostop: ReadWrite<u32, Configuration::Register>),
        (0x0A0 => subscribe_hfclk192mstart: ReadWrite<u32, Configuration::Register>),
        (0x0A4 => subscribe_hfclk192mstop: ReadWrite<u32, Configuration::Register>),
        (0x0A8 => _reserved4),
        ...
        (0x128 => _reserved6),
        (0x180 => publish_hfclkstarted: ReadWrite<u32, Configuration::Register>),
        (0x184 => publish_lfclkstarted: ReadWrite<u32, Configuration::Register>),
        (0x188 => _reserved7),
        (0x19C => publish_done: ReadWrite<u32, Configuration::Register>),
        (0x1A0 => publish_hfclkaudiostarted: ReadWrite<u32, Configuration::Register>),
        (0x1A4 => publish_hfclk192mstarted: ReadWrite<u32, Configuration::Register>),
        (0x1A8 => _reseved8),
...
impl Clock {
    ...
    pub fn interrupt_enable(&self, interrupt: InterruptField) {
        ...
        match interrupt {
            ...
            InterruptField::HFCLKAUDIOSTARTED => regs.intenset.write(Interrupt::HFCLKAUDIOSTARTED::SET),
            InterruptField::HFCLK192MSTARTED => regs.intenset.write(Interrupt::HFCLK192MSTARTED::SET),
        }
    }
    ...
    pub fn audio_started(&self) -> bool {
        let regs = &*self.registers;
        regs.events_hfclkaudiostarted.matches_all(Status::READY.val(1))
    }

    /// Check if the high frequency audio clock is running
    pub fn audio_running(&self) -> bool {
        let regs = &*self.registers;
        regs.hfclkaudiostat.matches_all(HfClkAudioStat::STATE::RUNNING)
    }
    ...
    pub fn high_192m_started(&self) -> bool {
        let regs = &*self.registers;
        regs.events_hfclk192mstarted.matches_all(Status::READY.val(1))
    }
