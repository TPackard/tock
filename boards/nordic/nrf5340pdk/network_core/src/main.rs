...
static mut CHIP: Option<&'static nrf53::chip::NRF53<nrf53::interrupt_service::NetCoreInterruptService>> = None;
...
pub unsafe fn reset_handler() {
    ...
    */
    ...
    let led = components::led::LedsComponent::new(components::led_component_helper!(
        ...
        /*
        (
            &nrf53::gpio::PORT_NET[LED1_PIN],
            kernel::hil::gpio::ActivationMode::ActiveLow
        ),
        (
            &nrf53::gpio::PORT_NET[LED2_PIN],
            kernel::hil::gpio::ActivationMode::ActiveLow
        ),
        */
        (
            &nrf53::gpio::PORT_NET[LED3_PIN],
            kernel::hil::gpio::ActivationMode::ActiveLow
        ),
        (
            &nrf53::gpio::PORT_NET[LED4_PIN],
            kernel::hil::gpio::ActivationMode::ActiveLow
        )
    ))
    ...
    nrf53::gpio::PORT_NET[LED4_PIN].set();
